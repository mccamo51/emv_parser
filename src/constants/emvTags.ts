...
export const EMV_TAGS: Record<string, EMVTagDefinition> = {
  '5F2A': {
    tag: '5F2A',
...
export const FIELD48_TAGS: Record<string, EMVTagDefinition> = {
  '001': {
    tag: '001',
    name: 'Fee Percent',
...
export const TRANSACTION_REQUIREMENTS: Record<RequestType, { mandatoryTags: string[]; optionalTags: string[]; description: string }> = {
  authorization: {
...
export const FIELD48_REQUIREMENTS: Record<RequestType, { mandatoryTags: string[]; optionalTags: string[]; description: string }> = {
  authorization: {
    mandatoryTags: [],
